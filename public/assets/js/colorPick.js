    ...
    $.colorPick.prototype = {
        ...
        init : function(){
            ...
            this.element.click(function(event) {
                ...
                self.show(event.pageX - 150, event.pageY);
        ...
        show: function(left, top) {
            ...
            if ($("#colorPick").is(":visible")) {
                return;
            }

	        $("body").append('<div id="colorPick" style="display:none;top:' + top + 'px;left:' + left + 'px"><span>Priority Color:</span></div>');
